...
class ArgosRepository {
  ArgosRepository._();
  static LoadingMoreBase<BookItem> popular() {
    return ArgosRepositoryP();
  }

  static LoadingMoreBase<BookItem> latest() {
    return ArgosRepositoryL();
  }
}

class ArgosRepositoryP extends LoadingMoreBase<BookItem> {
